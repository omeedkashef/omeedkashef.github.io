...
const WORK = [
  {
    ...
    text: 'Analyses business use cases and builds requirement documents to generate full-stack applications, using AI to design system architectures on MERN and Java/Spring Boot stacks. Combines UX, human factors and systems thinking to improve product-market fit.',
  },
  {
  ...
  },
  {
    ...
    text: 'Managed the integration of parts and information into Agile PLM for production of a robotic arm at Amazon, and ran human factors and UX studies for clients across medical device, robotics, web and mobile. Developed and tested interactive Figma prototypes with more than 50 participants, improving first-click success by 22%.',
  },
  {
    role: 'Usability Consultant',
    org: 'Haemonetics',
    dates: 'December 2022 – April 2023',
    text: 'Conducted task analysis, use FMEA, usability plans and use specifications for a Class II medical device. Applied IEC 62366, ANSI HE75, ISO 14971 and FDA guidance to a failure mode and effects analysis, identifying 18 high-risk tasks for a blood-processing device.',
  },
  {
    role: 'Product Owner',
    org: 'Ford Motor Company',
    dates: 'October 2019 – September 2022',
    text: "Led an agile team of eight to deliver the prototype of Ford's first in-vehicle onboarding experience; usability testing with more than 60 participants across three user groups produced a 95% user acceptance rate. Managed OKRs, timelines, backlog and sprints with stakeholders, and mentored coworkers in design thinking and human factors.",
  },
  {
    role: 'Human Factors Researcher',
    org: 'Driving Safety Research Institute',
    dates: 'August 2017 – August 2019',
    text: 'Developed attentional maintenance algorithms for camera-based driver monitoring in highly automated vehicles, demonstrating a 22% increase in situational awareness and a 28% decrease in reaction time. Built the front end of a 3-D virtual driving environment and analysed gaze transitions and takeover response times in R.',
  },
]
...
const PROJECTS = [
  ...
  },
  {
    ...
    text: 'Web app connecting low-income residents to legal aid, housing and social services, co-designed with community organisers across three U.S. cities so the routes it offers reflect what is actually available.',
    img: justiceAccess,
  ...
  },
  {
    ...
    text: 'B2B SaaS tool helping small and medium enterprises audit and publish supplier labour standards, taken from requirements through MVP in partnership with a fair-trade certification body.',
    img: supplyChain,
